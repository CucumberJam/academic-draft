...
import com.example.academicdraft.entity.Role;
import com.example.academicdraft.entity.User;
import com.example.academicdraft.repository.RoleRepository;
...
public class UserServiceImpl  implements UserService{
    ...
    public void saveUser(UserDto userDto){
        User user = new User();
        user.setName(userDto.getType() + " " + userDto.getName());
